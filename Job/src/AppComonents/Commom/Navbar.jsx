...
const GlassNavbar = () => {
  ...
  return (
    <nav className="fixed top-4 left-0 w-full z-20">
      <div className="mx-4 md:mx-16 lg:mx-32 px-4 py-2 bg-white/5 backdrop-blur-sm border border-gray-700 text-gray-700 flex rounded-lg h-16 text-base md:text-lg lg:text-xl  justify-between">
        {/* Logo */}
        <Link to="/">
            ...
            isAuthenticated ? (
             ...
             animate-gradient-border bg-[length:200%_200%] shadow-md border-2 p-[1px]">
              ...
              <div className="flex items-center gap-2">
                <Link to="/auth">
                  <Button className="relative border-white bg-gradient-to-l from-purple-500 via-pink-500 to-yellow-500 text-white 
